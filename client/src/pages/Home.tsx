          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Based on 4 quarterly outcome reports at ~$150/hr consultant rates — the cost a mid-to-large nonprofit avoids.",
                color: "text-[#B86890]",
                bg: "bg-[#FAF0F3]",
              },
              {
                ...
                desc: "What takes consultants 36 hours to produce by hand, SurveyMetrix generates automatically in under 4.",
                color: "text-[#5550BA]",
                bg: "bg-[#EEEDfb]",
              },
              {
